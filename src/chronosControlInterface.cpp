 ...
 * Command line was: qdbusxml2cpp -p chronosControlInterface ../com.krontech.chronos.control.xml
 *
...
/*
 * Implementation of interface class ComKrontechChronosControlInterface
 */

ComKrontechChronosControlInterface::ComKrontechChronosControlInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent)
    : QDBusAbstractInterface(service, path, staticInterfaceName(), connection, parent)
{
}

ComKrontechChronosControlInterface::~ComKrontechChronosControlInterface()
{
}
