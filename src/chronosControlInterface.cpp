 ...
 * Command line was: qdbusxml2cpp -p chronosControlInterface ../ca.krontech.chronos.control.xml
 *
...
/*
 * Implementation of interface class CaKrontechChronosControlInterface
 */

CaKrontechChronosControlInterface::CaKrontechChronosControlInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent)
    : QDBusAbstractInterface(service, path, staticInterfaceName(), connection, parent)
{
}

CaKrontechChronosControlInterface::~CaKrontechChronosControlInterface()
{
}
