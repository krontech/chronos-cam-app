...
int eeprom_read(int fd, unsigned int addr, unsigned int offset, unsigned char *buf, unsigned char len);
int eeprom_write_large(int fd, unsigned int addr, unsigned int offset, unsigned char *buf, unsigned char len);
int eeprom_read_large(int fd, unsigned int addr, unsigned int offset, unsigned char *buf, unsigned char len);
