...
public Q_SLOTS: // METHODS
    inline QDBusPendingReply<QVariantMap> get_camera_data()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QLatin1String("get_camera_data"), argumentList);
    }

    inline QDBusPendingReply<QVariantMap> get_sensor_data()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QLatin1String("get_sensor_data"), argumentList);
    }
