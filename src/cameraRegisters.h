...
//---------------------------------- Timing Program Block ----------------------------------------

#define TIMING_REG_BASE				(0x6100)

/* Timing Registers */
#define TIMING_IDENTIFIER_REG		(TIMING_REG_BASE + 0x00)
#define TIMING_VERSION_REG			(TIMING_REG_BASE + 0x02)
#define TIMING_SUBVERSION_REG		(TIMING_REG_BASE + 0x04)
#define TIMING_STATUS				(TIMING_REG_BASE + 0x06)
#define TIMING_CONTROL				(TIMING_REG_BASE + 0x08)
#define TIMING_PULSED_ABN_LOW		(TIMING_REG_BASE + 0x0A)
#define TIMING_PULSED_ABN_HIGH		(TIMING_REG_BASE + 0x0C)
#define TIMING_MIN_LINES			(TIMING_REG_BASE + 0x0E)
#define TIMING_PROGRAM				(TIMING_REG_BASE + 0x10)

/* Timing Status Flags */
#define TIMING_STATUS_ACTIVE_PAGE		(0x0008)
#define TIMING_STATUS_EXPOSURE_ENABLE	(0x0040)
#define TIMING_STATUS_FREQ_REQ_NOT_DONE	(0x0080)
#define TIMING_STATUS_WAIT_FOR_ACTIVE	(0x0100)
#define TIMING_STATUS_WAIT_FOR_INACTIVE	(0x0200)
#define TIMING_STATUS_PAGE_SWAP_STATE	(0xF000)

/* Timing Control Flags */
#define TIMING_CONTROL_INHIBIT			(0x0001)
#define TIMING_CONTROL_REQUEST_FLIP		(0x0002)
#define TIMING_CONTROL_RESET			(0x0004)
#define TIMING_CONTROL_EXPOSURE_ENABLE	(0x0010)
#define TIMING_CONTROL_ABN_PULSE_MODE	(0x0100)
#define TIMING_CONTROL_INVERT_ABN_PULSE	(0x0200)
#define TIMING_CONTROL_WAVETABLE_LATCH	(0x0400)

/* Timing Opcode Fields */
#define TIMING_OPCODE_DURATION			(0x00FFFFFF)
#define TIMING_OPCODE_ABN				(0x01000000)
#define TIMING_OPCODE_ABN2				(0x02000000)
#define TIMING_OPCODE_PRSTN				(0x04000000)
#define TIMING_OPCODE_TXN				(0x08000000)
#define TIMING_OPCODE_IODRIVE			(0x10000000)
#define TIMING_OPCODE_NONE				(0x00000000)

#define TIMING_OPCODE_RESTART			(0x00000000)
#define TIMING_OPCODE_WAIT_FOR_ACTIVE	(0x00FFFFFF)
#define TIMING_OPCODE_WAIT_FOR_INACTIVE	(0x00FFFFFE)
#define TIMING_OPCODE_WAIT_FOR_LINES	(0x00FFFFFC)
#define TIMING_OPCODE_MAX_CLOCKS		(0x00FFFFFD)
